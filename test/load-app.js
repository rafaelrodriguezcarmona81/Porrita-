...
const EXPOSED = [
  // helpers / lógica pura
  "gPts", "podiumBonus", "bracketPts", "phasePoints", "fmtTime", "fmtKO", "tvChannel", "isLocked", "fl", "pill", "card", "esc",
  ...
  "renderPodium", "renderRanking", "renderBracket", "renderBracketMap", "renderAdmin",
  // capa de datos / red
